<template>
  <AutheticateLayout title="Profile">
    <div class="min-h-screen container flex justify-center">
      <div class="shadow-md w-full md:w-2/4">
        <div
          class="flex items-center justify-between gap-x-2 cursor-pointer bg-purple-600 p-5 pt-14"
        >
        ...
        <div class="p-5">
          <h1 class="text-2xl text-purple-600 font-bold">Information</h1>
          <hr class="mt-2 mb-7" />
