<template>
  <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5">
    <div class="px-6 flex items-center justify-between space-x-4 2xl:container">
      <h5 hidden class="text-2xl text-purple-600 font-medium lg:block">
        {{ title }}
      </h5>
      <button
      ...
      <div class="flex space-x-4">
        ...
        <div hidden class="md:block">
          <div
            class="relative flex items-center text-gray-400 focus-within:text-purple-400"
          >
            <span
            ...
            <input
              ...
              class="w-full pl-14 pr-4 py-2.5 rounded-xl text-sm text-gray-600 outline-none border border-gray-300 focus:border-purple-300 transition"
            />
          </div>
        </div>
        <!--/search bar -->
        ...
        <div>
          ...
          >
            <ul class="text-sm text-gray-700 dark:text-gray-200">
              <li class="block py-2 hover:bg-purple-100 cursor-pointer">
                <div class="gap-3 flex items-center justify-center">
                  ...
                  <router-link to="/profile" class="text-purple-500"
                    >Profile</router-link
                  >
                </div>
              </li>
